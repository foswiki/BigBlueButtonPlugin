#!perl
#
# Install script for BigBlueButtonPlugin
#
...
Foswiki::Extender::install( $PACKAGES_URL, 'BigBlueButtonPlugin', 'BigBlueButtonPlugin', @DATA );
...
lib/Foswiki/Plugins/BigBlueButtonPlugin/Config.spec,0444,config file for =configure= 

<<<< DEPENDENCIES >>>>
URI::Escape,>=3.28,1,cpan,Required.
Digest::SHA1,>=2.12,1,cpan,Required.
LWP::UserAgent,>=2.033,1,cpan,Required.
HTTP::Request,>=1.40,1,cpan,Required.
XML::Simple,>=2.18,1,cpan,Required.
JSON,>=2.21,1,cpan,Required.
BigBlueButton,>=0.7,1,external,Required, the web conferencing service this plugin connects to.
